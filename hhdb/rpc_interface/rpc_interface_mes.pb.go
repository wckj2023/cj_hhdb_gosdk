...
type QueryPointInfoReq struct {
	...
	TableName   string            `protobuf:"bytes,1,opt,name=tableName,proto3" json:"tableName,omitempty"`                                                                                             //查询的点表名，为空时使用tableId为准，不为空时，以tableName进行查找
	TableId     int32             `protobuf:"varint,2,opt,name=tableId,proto3" json:"tableId,omitempty"`                                                                                                //<0时，整库查询，>=0时在指定表内检索
	PointId     int32             `protobuf:"varint,3,opt,name=pointId,proto3" json:"pointId,omitempty"`                                                                                                //测点ID，>=0时，查询指定测点ID的信息
	NameRegex   string            `protobuf:"bytes,4,opt,name=nameRegex,proto3" json:"nameRegex,omitempty"`                                                                                             //不为空时，按正则匹配点名符合的测点
	DescRegex   string            `protobuf:"bytes,5,opt,name=descRegex,proto3" json:"descRegex,omitempty"`                                                                                             //不为空时，按正则匹配描述符合的测点，两则都不为空时取交集
	UnitRegex   string            `protobuf:"bytes,6,opt,name=unitRegex,proto3" json:"unitRegex,omitempty"`                                                                                             //不为空时，按正则匹配
	PointType   int32             `protobuf:"varint,7,opt,name=pointType,proto3" json:"pointType,omitempty"`                                                                                            //测点类型，>=0时，查询指定测点类型的信息
	ExtraFields map[string]string `protobuf:"bytes,8,rep,name=extraFields,proto3" json:"extraFields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //需要检索的字段，key为字段名，value为检索的字段值
	EnablePage  bool              `protobuf:"varint,9,opt,name=enablePage,proto3" json:"enablePage,omitempty"`                                                                                          //是否启用分页
	Page        uint32            `protobuf:"varint,10,opt,name=page,proto3" json:"page,omitempty"`                                                                                                     //页数,page从0开始计数
	Limit       uint32            `protobuf:"varint,11,opt,name=limit,proto3" json:"limit,omitempty"`                                                                                                   //每页的数量
}
...
var file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDesc = []byte{
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x8c, 0x01,
	0x0a, 0x0f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x70, 0x6c,
	...
	,
	...
	,
	...
	0x61, 0x67, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x50, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d,
	0x69, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x1a,
