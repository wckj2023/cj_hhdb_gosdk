...
type ReqUserInfo struct {
	...
	Token []byte `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` //认证token
}
...
func (x *ReqUserInfo) GetToken() []byte {
	if x != nil {
		return x.Token
	}
	return nil
...
type AuthReq struct {
	...
	Password []byte `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` //用户密码，md5加密后的字符串
}
...
func (x *AuthReq) GetPassword() []byte {
	if x != nil {
		return x.Password
	}
	return nil
...
type ValueList struct {
	...
	MstimeList []uint64          `protobuf:"varint,3,rep,packed,name=mstimeList,proto3" json:"mstimeList,omitempty"`                           //数据utc毫秒时间戳，与测点值列表的下标一一对应
	StatusList []rpc.PointStatus `protobuf:"varint,4,rep,packed,name=statusList,proto3,enum=hhdb.rpc.PointStatus" json:"statusList,omitempty"` //数据值状态，与测点值列表的下标一一对应
}
...
func (x *ValueList) GetMstimeList() []uint64 {
	if x != nil {
		return x.MstimeList
	}
	return nil
...
func (x *ValueList) GetStatusList() []rpc.PointStatus {
	if x != nil {
		return x.StatusList
	}
	return nil
...
type ValueListReply struct {
	...
	MstimeList []uint64          `protobuf:"varint,3,rep,packed,name=mstimeList,proto3" json:"mstimeList,omitempty"`                           //数据utc毫秒时间戳，与测点值列表的下标一一对应
	StatusList []rpc.PointStatus `protobuf:"varint,4,rep,packed,name=statusList,proto3,enum=hhdb.rpc.PointStatus" json:"statusList,omitempty"` //数据值状态，与测点值列表的下标一一对应
	ResultList []int32           `protobuf:"varint,5,rep,packed,name=resultList,proto3" json:"resultList,omitempty"`                           //批量操作的各个结果值，全成功时为空
}
...
func (x *ValueListReply) GetMstimeList() []uint64 {
	if x != nil {
		return x.MstimeList
	}
	return nil
...
func (x *ValueListReply) GetStatusList() []rpc.PointStatus {
	if x != nil {
		return x.StatusList
	}
	return nil
...
type UpdateRealtimeValueListReq struct {
	...
	MstimeList        []uint64          `protobuf:"varint,4,rep,packed,name=mstimeList,proto3" json:"mstimeList,omitempty"`                           //数据utc毫秒时间戳，与测点ID的下标一一对应,useServerTimeFlag为true时，为空
	StatusList        []rpc.PointStatus `protobuf:"varint,5,rep,packed,name=statusList,proto3,enum=hhdb.rpc.PointStatus" json:"statusList,omitempty"` //数据值状态，与测点ID的下标一一对应
	UseServerTimeFlag bool              `protobuf:"varint,6,opt,name=useServerTimeFlag,proto3" json:"useServerTimeFlag,omitempty"`                    //是否使用服务器的系统时间,为true则不用valueList中的时间
}
...
func (x *UpdateRealtimeValueListReq) GetMstimeList() []uint64 {
	if x != nil {
		return x.MstimeList
	}
	return nil
...
func (x *UpdateRealtimeValueListReq) GetStatusList() []rpc.PointStatus {
	if x != nil {
		return x.StatusList
	}
	return nil
...
type QueryHisValueListReply struct {
	...
	ErrMsg     *rpc.ErrMsg  `protobuf:"bytes,1,opt,name=errMsg,proto3" json:"errMsg,omitempty"`                 //错误码
	ValuesList []*ValueList `protobuf:"bytes,2,rep,name=valuesList,proto3" json:"valuesList,omitempty"`         //测点值列表
...
func (x *QueryHisValueListReply) GetValuesList() []*ValueList {
	if x != nil {
		return x.ValuesList
	}
	return nil
...
type InsertHisValueListReq struct {
	...
	IdList     []int32      `protobuf:"varint,1,rep,packed,name=idList,proto3" json:"idList,omitempty"` //测点ID列表，为空时使用nameList进行写入
	NameList   []string     `protobuf:"bytes,2,rep,name=nameList,proto3" json:"nameList,omitempty"`     //测点名列表
	ValuesList []*ValueList `protobuf:"bytes,3,rep,name=valuesList,proto3" json:"valuesList,omitempty"` //测点值列表
}
...
func (x *InsertHisValueListReq) GetValuesList() []*ValueList {
	if x != nil {
		return x.ValuesList
	}
	return nil
...
type QueryHisTimePointValueListReq struct {
	...
	IdList       []int32      `protobuf:"varint,1,rep,packed,name=idList,proto3" json:"idList,omitempty"`                                           //测点ID列表，为空时使用nameList进行写入
	NameList     []string     `protobuf:"bytes,2,rep,name=nameList,proto3" json:"nameList,omitempty"`                                               //测点名列表
	MsTimePoint  []uint64     `protobuf:"varint,3,rep,packed,name=msTimePoint,proto3" json:"msTimePoint,omitempty"`                                 //查询时间点
...
var file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
	...
	0x22, 0x96, 0x01, 0x0a, 0x09, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x32,
	...
	0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x73, 0x74, 0x69, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0a, 0x6d, 0x73, 0x74, 0x69, 0x6d, 0x65, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x35, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4c, 0x69, 0x73, 0x74,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x68, 0x68, 0x64, 0x62, 0x2e, 0x72, 0x70,
	0x63, 0x2e, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0a, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x63, 0x0a, 0x1f, 0x51, 0x75, 0x65,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x06, 0x69, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xe5,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x89, 0x02, 0x0a, 0x1a, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c,
	...
	0x52, 0x08, 0x6e, 0x61, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x09, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	,
	...
	0x72, 0x4d, 0x73, 0x67, 0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x12, 0x3d, 0x0a, 0x0a,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	...
	0x0a, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x72,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x05, 0x52,
	0x0a, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xf3, 0x01, 0x0a, 0x1d,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x48, 0x69, 0x73, 0x52, 0x65, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65,
	...
	,
	...
	0x3d, 0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20,
	...
	0x73, 0x74, 0x52, 0x0a, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xbb,
	...
	,
	...
	0x52, 0x71, 0x6d, 0x52, 0x61, 0x74, 0x65, 0x10, 0x0e, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x72,
	0x70, 0x63, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_hhdb_rpc_interface_rpc_interface_mes_proto_goTypes = []interface{}{
	...
	(rpc.PointStatus)(0),                    // 30: hhdb.rpc.PointStatus
}
var file_hhdb_rpc_interface_rpc_interface_mes_proto_depIdxs = []int32{
	...
	30, // 10: hhdb.rpc_interface.ValueList.statusList:type_name -> hhdb.rpc.PointStatus
	26, // 11: hhdb.rpc_interface.QueryPointIdListByNameListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	26, // 12: hhdb.rpc_interface.ValueListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	29, // 13: hhdb.rpc_interface.ValueListReply.valueList:type_name -> hhdb.rpc.PointValue
	30, // 14: hhdb.rpc_interface.ValueListReply.statusList:type_name -> hhdb.rpc.PointStatus
	29, // 15: hhdb.rpc_interface.UpdateRealtimeValueListReq.valueList:type_name -> hhdb.rpc.PointValue
	30, // 16: hhdb.rpc_interface.UpdateRealtimeValueListReq.statusList:type_name -> hhdb.rpc.PointStatus
	1,  // 17: hhdb.rpc_interface.QueryHisRangeValueListReq.queryMode:type_name -> hhdb.rpc_interface.RangeQueryMode
	26, // 18: hhdb.rpc_interface.QueryHisValueListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	15, // 19: hhdb.rpc_interface.QueryHisValueListReply.valuesList:type_name -> hhdb.rpc_interface.ValueList
	0,  // 20: hhdb.rpc_interface.QueryHisResamplesValueListReq.resampleMode:type_name -> hhdb.rpc_interface.ResampleMode
	15, // 21: hhdb.rpc_interface.InsertHisValueListReq.valuesList:type_name -> hhdb.rpc_interface.ValueList
	0,  // 22: hhdb.rpc_interface.QueryHisTimePointValueListReq.resampleMode:type_name -> hhdb.rpc_interface.ResampleMode
