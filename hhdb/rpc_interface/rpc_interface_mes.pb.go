...
type QueryTableReq struct {
	...
	TableDesc        string `protobuf:"bytes,4,opt,name=tableDesc,proto3" json:"tableDesc,omitempty"`                //表描述
	QueryChildren    bool   `protobuf:"varint,5,opt,name=queryChildren,proto3" json:"queryChildren,omitempty"`       //是否查询当前点组的子点组,启用只查询一级子节点
	QueryAllChildren bool   `protobuf:"varint,6,opt,name=queryAllChildren,proto3" json:"queryAllChildren,omitempty"` //在启用queryChildren的同时,查询多层级字节点
	EnablePage       bool   `protobuf:"varint,7,opt,name=enablePage,proto3" json:"enablePage,omitempty"`             //是否启用分页
	Page             uint32 `protobuf:"varint,8,opt,name=page,proto3" json:"page,omitempty"`                         //页数,page从0开始计数
	Limit            uint32 `protobuf:"varint,9,opt,name=limit,proto3" json:"limit,omitempty"`                       //每页的数量
}
...
func (x *QueryTableReq) GetTableShowName() string {
	if x != nil {
...
func (x *QueryTableReq) GetTableDesc() string {
	if x != nil {
		return x.TableDesc
	}
	return ""
...
func (x *QueryTableReq) GetQueryChildren() bool {
	if x != nil {
		return x.QueryChildren
	}
	return false
}

func (x *QueryTableReq) GetQueryAllChildren() bool {
	if x != nil {
		return x.QueryAllChildren
	}
	return false
}
...
type QueryTableReply struct {
	...
	ErrMsg        *rpc.ErrMsg      `protobuf:"bytes,1,opt,name=errMsg,proto3" json:"errMsg,omitempty"`               //错误码
	Total         int32            `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`                //查询总量
	TableInfoList []*rpc.TableInfo `protobuf:"bytes,3,rep,name=tableInfoList,proto3" json:"tableInfoList,omitempty"` //点表信息列表
}
...
func (x *QueryTableReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
// 测点数量信息请求
type QueryPointCountReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	QueryAllChildren bool   `protobuf:"varint,1,opt,name=queryAllChildren,proto3" json:"queryAllChildren,omitempty"` //当指定表进行查询时，是否包含子表的点数
	TableId          int32  `protobuf:"varint,2,opt,name=tableId,proto3" json:"tableId,omitempty"`                   //表ID，<0时，则使用group_name进行模糊匹配
	TableName        string `protobuf:"bytes,3,opt,name=tableName,proto3" json:"tableName,omitempty"`                //表名，为空时，则整库统计
}

func (x *QueryPointCountReq) Reset() {
	*x = QueryPointCountReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryPointCountReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPointCountReq) ProtoMessage() {}

func (x *QueryPointCountReq) ProtoReflect() protoreflect.Message {
	mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryPointCountReq.ProtoReflect.Descriptor instead.
func (*QueryPointCountReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{8}
}

func (x *QueryPointCountReq) GetQueryAllChildren() bool {
	if x != nil {
		return x.QueryAllChildren
	}
	return false
...
func (x *QueryPointCountReq) GetTableId() int32 {
	if x != nil {
		return x.TableId
	}
	return 0
...
func (x *QueryPointCountReq) GetTableName() string {
	if x != nil {
		return x.TableName
	}
	return ""
...
// 测点数量信息响应
type QueryPointCountReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SwitchTotal  int32       `protobuf:"varint,3,opt,name=switchTotal,proto3" json:"switchTotal,omitempty"`   //开关量总数
	AnalogTotal  int32       `protobuf:"varint,4,opt,name=analogTotal,proto3" json:"analogTotal,omitempty"`   //模拟量总数
	PackageTotal int32       `protobuf:"varint,5,opt,name=packageTotal,proto3" json:"packageTotal,omitempty"` //打包点总数
}

func (x *QueryPointCountReply) Reset() {
	*x = QueryPointCountReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryPointCountReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPointCountReply) ProtoMessage() {}

func (x *QueryPointCountReply) ProtoReflect() protoreflect.Message {
	mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryPointCountReply.ProtoReflect.Descriptor instead.
func (*QueryPointCountReply) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{9}
}

func (x *QueryPointCountReply) GetErrMsg() *rpc.ErrMsg {
	if x != nil {
		return x.ErrMsg
	}
	return nil
...
func (x *QueryPointCountReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *QueryPointCountReply) GetSwitchTotal() int32 {
	if x != nil {
		return x.SwitchTotal
	}
	return 0
}

func (x *QueryPointCountReply) GetAnalogTotal() int32 {
	if x != nil {
		return x.AnalogTotal
	}
	return 0
}

func (x *QueryPointCountReply) GetPackageTotal() int32 {
	if x != nil {
...
type QueryPointInfoReq struct {
	...
	PointId          int32             `protobuf:"varint,1,opt,name=pointId,proto3" json:"pointId,omitempty"`                                                                                                //测点ID，>=0时，查询指定测点ID的信息
	TableId          int32             `protobuf:"varint,2,opt,name=tableId,proto3" json:"tableId,omitempty"`                                                                                                //<0时，整库查询，>=0时在指定表内检索
	TableName        string            `protobuf:"bytes,3,opt,name=tableName,proto3" json:"tableName,omitempty"`                                                                                             //查询的测点名，为空时使用tableId为准，不为空时，以tableName进行查找
	ShowNameRegex    string            `protobuf:"bytes,4,opt,name=showNameRegex,proto3" json:"showNameRegex,omitempty"`                                                                                     //查询的测点名，为空时使用tableId为准，不为空时，以tableName进行查找
	NameRegex        string            `protobuf:"bytes,5,opt,name=nameRegex,proto3" json:"nameRegex,omitempty"`                                                                                             //不为空时，按正则匹配点名符合的测点
	...
	QueryChildren    bool              `protobuf:"varint,13,opt,name=queryChildren,proto3" json:"queryChildren,omitempty"`                                                                                   //是否查询当前点组的子点组,启用只查询一级子节点
	QueryAllChildren bool              `protobuf:"varint,14,opt,name=queryAllChildren,proto3" json:"queryAllChildren,omitempty"`                                                                             //在启用queryChildren的同时,查询多层级子节点
}
...
func (x *QueryPointInfoReq) GetTableName() string {
	if x != nil {
		return x.TableName
	}
	return ""
...
func (x *QueryPointInfoReq) GetShowNameRegex() string {
	if x != nil {
		return x.ShowNameRegex
	}
	return ""
}
...
func (x *QueryPointInfoReq) GetQueryChildren() bool {
	if x != nil {
		return x.QueryChildren
	}
	return false
...
func (x *QueryPointInfoReq) GetQueryAllChildren() bool {
	if x != nil {
		return x.QueryAllChildren
	}
	return false
...
type QueryPointInfoReply struct {
	...
	ErrMsg        *rpc.ErrMsg      `protobuf:"bytes,1,opt,name=errMsg,proto3" json:"errMsg,omitempty"`               //错误码
	Total         int32            `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`                //满足匹配条件的总数量
	PointInfoList []*rpc.PointInfo `protobuf:"bytes,3,rep,name=pointInfoList,proto3" json:"pointInfoList,omitempty"` //查询获取到的测点信息
}
...
func (x *QueryPointInfoReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *NameListReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NameListReq) ProtoMessage() {}

func (x *NameListReq) ProtoReflect() protoreflect.Message {
	mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NameListReq.ProtoReflect.Descriptor instead.
func (*NameListReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{14}
}

func (x *NameListReq) GetNameList() []string {
	if x != nil {
		return x.NameList
	}
	return nil
...
func (x *IdOrNameListReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdOrNameListReq) ProtoMessage() {}

func (x *IdOrNameListReq) ProtoReflect() protoreflect.Message {
	mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdOrNameListReq.ProtoReflect.Descriptor instead.
func (*IdOrNameListReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{18}
}

func (x *IdOrNameListReq) GetIdList() []int32 {
	if x != nil {
		return x.IdList
	}
	return nil
...
func (x *IdOrNameListReq) GetNameList() []string {
	if x != nil {
		return x.NameList
	}
	return nil
...
// 通过测点ID写入测点数据请求体
type QueryPointsIsInIdsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	IdList        []int32            `protobuf:"varint,1,rep,packed,name=idList,proto3" json:"idList,omitempty"`        //测点ID列表，为空时使用nameList进行写入
	NameList      []string           `protobuf:"bytes,2,rep,name=nameList,proto3" json:"nameList,omitempty"`            //测点名列表
	InOrNotInFlag bool               `protobuf:"varint,3,opt,name=inOrNotInFlag,proto3" json:"inOrNotInFlag,omitempty"` //是否在idList范围内查找,true为在范围内,false为不在范围内的
	QueryInfo     *QueryPointInfoReq `protobuf:"bytes,4,opt,name=queryInfo,proto3" json:"queryInfo,omitempty"`          //查询测点的条件
}

func (x *QueryPointsIsInIdsReq) Reset() {
	*x = QueryPointsIsInIdsReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryPointsIsInIdsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPointsIsInIdsReq) ProtoMessage() {}

func (x *QueryPointsIsInIdsReq) ProtoReflect() protoreflect.Message {
	mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryPointsIsInIdsReq.ProtoReflect.Descriptor instead.
func (*QueryPointsIsInIdsReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{19}
}

func (x *QueryPointsIsInIdsReq) GetIdList() []int32 {
	if x != nil {
		return x.IdList
	}
	return nil
...
func (x *QueryPointsIsInIdsReq) GetNameList() []string {
	if x != nil {
		return x.NameList
	}
	return nil
...
func (x *QueryPointsIsInIdsReq) GetInOrNotInFlag() bool {
	if x != nil {
		return x.InOrNotInFlag
	}
	return false
}

func (x *QueryPointsIsInIdsReq) GetQueryInfo() *QueryPointInfoReq {
	if x != nil {
		return x.QueryInfo
	}
	return nil
...
type QueryHisRangeValueListReq struct {
	...
	QueryMode   int32    `protobuf:"varint,5,opt,name=queryMode,proto3" json:"queryMode,omitempty"`     //历史查询模式
}
...
func (x *QueryHisRangeValueListReq) GetQueryMode() int32 {
	if x != nil {
		return x.QueryMode
	}
	return 0
...
type QueryHisResamplesValueListReq struct {
	...
	StartMsTime  uint64   `protobuf:"varint,3,opt,name=startMsTime,proto3" json:"startMsTime,omitempty"`   //查询开始时间，单位毫秒
	EndMsTime    uint64   `protobuf:"varint,4,opt,name=endMsTime,proto3" json:"endMsTime,omitempty"`       //查询结束时间，单位毫秒
	PeriodMs     uint64   `protobuf:"varint,5,opt,name=periodMs,proto3" json:"periodMs,omitempty"`         //重采样的毫秒间隔，代表多长时间返回一个时间点，为0时只返回开始时间点和结束时间点的数据
	ResampleMode int32    `protobuf:"varint,6,opt,name=resampleMode,proto3" json:"resampleMode,omitempty"` //重采样的运算模式
}

func (x *QueryHisResamplesValueListReq) Reset() {
	*x = QueryHisResamplesValueListReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryHisResamplesValueListReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{23}
}
...
func (x *QueryHisResamplesValueListReq) GetPeriodMs() uint64 {
	if x != nil {
		return x.PeriodMs
	}
	return 0
...
func (x *QueryHisResamplesValueListReq) GetResampleMode() int32 {
	if x != nil {
...
func (x *InsertHisValueListReq) Reset() {
	*x = InsertHisValueListReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InsertHisValueListReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{24}
}
...
type QueryHisTimePointValueListReq struct {
	...
	IdList          []int32  `protobuf:"varint,1,rep,packed,name=idList,proto3" json:"idList,omitempty"`                   //测点ID列表，为空时使用nameList进行写入
	NameList        []string `protobuf:"bytes,2,rep,name=nameList,proto3" json:"nameList,omitempty"`                       //测点名列表
	MsTimePointList []uint64 `protobuf:"varint,3,rep,packed,name=msTimePointList,proto3" json:"msTimePointList,omitempty"` //查询开始时间，单位毫秒
	ResampleMode    int32    `protobuf:"varint,4,opt,name=resampleMode,proto3" json:"resampleMode,omitempty"`              //重采样的运算模式
}

func (x *QueryHisTimePointValueListReq) Reset() {
	*x = QueryHisTimePointValueListReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryHisTimePointValueListReq) Descriptor() ([]byte, []int) {
	return file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDescGZIP(), []int{25}
}
...
func (x *QueryHisTimePointValueListReq) GetMsTimePointList() []uint64 {
	if x != nil {
		return x.MsTimePointList
	}
	return nil
}

func (x *QueryHisTimePointValueListReq) GetResampleMode() int32 {
	if x != nil {
		return x.ResampleMode
	}
	return 0
...
var file_hhdb_rpc_interface_rpc_interface_mes_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x4d, 0x73, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xa7, 0x02, 0x0a, 0x0d, 0x51, 0x75,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x64, 0x4c, 0x69, 0x73, 0x74,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x06, 0x69, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x8e,
	0x01, 0x0a, 0x0e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c,
	...
	0x4d, 0x73, 0x67, 0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x12, 0x32, 0x0a, 0x09, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14,
	...
	,
	...
	,
...
var file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_hhdb_rpc_interface_rpc_interface_mes_proto_goTypes = []interface{}{
	...
	(*QueryPointCountReq)(nil),              // 10: hhdb.rpc_interface.QueryPointCountReq
	(*QueryPointCountReply)(nil),            // 11: hhdb.rpc_interface.QueryPointCountReply
	(*PointInfoListReq)(nil),                // 12: hhdb.rpc_interface.PointInfoListReq
	(*QueryPointInfoReq)(nil),               // 13: hhdb.rpc_interface.QueryPointInfoReq
	(*QueryPointInfoReply)(nil),             // 14: hhdb.rpc_interface.QueryPointInfoReply
	(*IdList)(nil),                          // 15: hhdb.rpc_interface.IdList
	(*NameListReq)(nil),                     // 16: hhdb.rpc_interface.NameListReq
	(*ValueList)(nil),                       // 17: hhdb.rpc_interface.ValueList
	(*QueryPointIdListByNameListReply)(nil), // 18: hhdb.rpc_interface.QueryPointIdListByNameListReply
	(*ValueListReply)(nil),                  // 19: hhdb.rpc_interface.ValueListReply
	(*IdOrNameListReq)(nil),                 // 20: hhdb.rpc_interface.IdOrNameListReq
	(*QueryPointsIsInIdsReq)(nil),           // 21: hhdb.rpc_interface.QueryPointsIsInIdsReq
	(*UpdateRealtimeValueListReq)(nil),      // 22: hhdb.rpc_interface.UpdateRealtimeValueListReq
	(*QueryHisRangeValueListReq)(nil),       // 23: hhdb.rpc_interface.QueryHisRangeValueListReq
	(*QueryHisValueListReply)(nil),          // 24: hhdb.rpc_interface.QueryHisValueListReply
	(*QueryHisResamplesValueListReq)(nil),   // 25: hhdb.rpc_interface.QueryHisResamplesValueListReq
	(*InsertHisValueListReq)(nil),           // 26: hhdb.rpc_interface.InsertHisValueListReq
	(*QueryHisTimePointValueListReq)(nil),   // 27: hhdb.rpc_interface.QueryHisTimePointValueListReq
	nil,                                     // 28: hhdb.rpc_interface.QueryPointInfoReq.ExtraFieldsEntry
	(*rpc.ErrMsg)(nil),                      // 29: hhdb.rpc.ErrMsg
	(*rpc.TableInfo)(nil),                   // 30: hhdb.rpc.TableInfo
	(*rpc.PointInfo)(nil),                   // 31: hhdb.rpc.PointInfo
	(*rpc.PointValue)(nil),                  // 32: hhdb.rpc.PointValue
}
var file_hhdb_rpc_interface_rpc_interface_mes_proto_depIdxs = []int32{
	29, // 0: hhdb.rpc_interface.AuthReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	2,  // 1: hhdb.rpc_interface.AuthReply.userInfo:type_name -> hhdb.rpc_interface.ReqUserInfo
	29, // 2: hhdb.rpc_interface.CommonReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	29, // 3: hhdb.rpc_interface.QueryTableReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	30, // 4: hhdb.rpc_interface.QueryTableReply.tableInfoList:type_name -> hhdb.rpc.TableInfo
	29, // 5: hhdb.rpc_interface.QueryPointCountReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	31, // 6: hhdb.rpc_interface.PointInfoListReq.pointInfoList:type_name -> hhdb.rpc.PointInfo
	28, // 7: hhdb.rpc_interface.QueryPointInfoReq.extraFields:type_name -> hhdb.rpc_interface.QueryPointInfoReq.ExtraFieldsEntry
	29, // 8: hhdb.rpc_interface.QueryPointInfoReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	31, // 9: hhdb.rpc_interface.QueryPointInfoReply.pointInfoList:type_name -> hhdb.rpc.PointInfo
	32, // 10: hhdb.rpc_interface.ValueList.valueList:type_name -> hhdb.rpc.PointValue
	29, // 11: hhdb.rpc_interface.QueryPointIdListByNameListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	29, // 12: hhdb.rpc_interface.ValueListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	32, // 13: hhdb.rpc_interface.ValueListReply.valueList:type_name -> hhdb.rpc.PointValue
	13, // 14: hhdb.rpc_interface.QueryPointsIsInIdsReq.queryInfo:type_name -> hhdb.rpc_interface.QueryPointInfoReq
	32, // 15: hhdb.rpc_interface.UpdateRealtimeValueListReq.valueList:type_name -> hhdb.rpc.PointValue
	29, // 16: hhdb.rpc_interface.QueryHisValueListReply.errMsg:type_name -> hhdb.rpc.ErrMsg
	17, // 17: hhdb.rpc_interface.QueryHisValueListReply.valueLists:type_name -> hhdb.rpc_interface.ValueList
	17, // 18: hhdb.rpc_interface.InsertHisValueListReq.valueLists:type_name -> hhdb.rpc_interface.ValueList
...
func file_hhdb_rpc_interface_rpc_interface_mes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPointCountReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPointCountReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPointsIsInIdsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_hhdb_rpc_interface_rpc_interface_mes_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
