...
type TableInfo struct {
	...
	ExtraFiledAndDesc map[string]string `protobuf:"bytes,6,rep,name=extraFiledAndDesc,proto3" json:"extraFiledAndDesc,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //表中其他属性
