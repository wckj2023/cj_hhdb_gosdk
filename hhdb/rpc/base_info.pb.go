...
const (
	...
	ValueType_kVtGeo       ValueType = 11 //无符号的 64 位整数数据
	ValueType_kVtString    ValueType = 12 //字符串
	ValueType_kVtBinary    ValueType = 13 //二进制
...
const (
	PointState_kPsInit             PointState = 0  //初始化0-19为好的状态
	PointState_kPsGood             PointState = 1  //正常,表示测点的值是有效的且在正常范围内。这是最常见的状态
	PointState_kPsShowWarnning     PointState = 20 //>=20为警告状态
	PointState_kPsUncertain        PointState = 21 //不确定,表示测点的值可能有效，但存在某种不确定性或不可靠性。这通常用于表示数据质量差、未知状态或临时问题。
	PointState_kPsInavtive         PointState = 22 //不活动,表示测点当前处于非活动状态，可能是因为设备已停用或者该测点当前不可用。
	PointState_kPsQualityIssue     PointState = 23 //数据质量问题,表示测点的数据存在质量问题，可能是由于噪声、干扰或其他原因导致的不准确性。
	PointState_kPsDataTypeMisMatch PointState = 24 //数据类型不匹配
	PointState_kPsOutService       PointState = 25 //停用,表示测点当前处于停用状态，通常是因为设备维护或其他原因。
	PointState_kPsOverRange        PointState = 26 //超出范围,表示测点的值超出了其正常范围，通常用于指示测点的测量值超出了可接受的上限。
	PointState_kPsUnderRange       PointState = 27 //低于范围,表示测点的值低于其正常范围，通常用于指示测点的测量值低于可接受的下限。
	PointState_kPsShowError        PointState = 80 //>=80为错误状态
	PointState_kPsNotFound         PointState = 81 //错误,表示测点的值无效或处于错误状态。
	PointState_kPsBad              PointState = 82 //错误,表示测点的值无效或处于错误状态。
	PointState_kPsDeviceFailure    PointState = 83 //设备故障,表示测点所关联的设备发生故障，无法提供有效的数据。
	PointState_kPsSensorFailure    PointState = 84 //传感器故障,表示与测点关联的传感器发生故障，导致无法获得有效的测量数据。
	PointState_kPsCommunFailure    PointState = 85 //通信故障,表示测点与数据源之间的通信故障，导致无法获取或更新数据。
)
...
type PointValue struct {
	...
	Mstime uint64             `protobuf:"varint,18,opt,name=mstime,proto3" json:"mstime,omitempty"` //数据utc毫秒时间戳
	State  int32              `protobuf:"varint,19,opt,name=state,proto3" json:"state,omitempty"`   //数据值状态
}
...
type PointValue_GeoValue struct {
	GeoValue *GeoValue `protobuf:"bytes,10,opt,name=geoValue,proto3,oneof"`
}

type PointValue_BoolArr struct {
	BoolArr *BoolArr `protobuf:"bytes,11,opt,name=boolArr,proto3,oneof"`
}

type PointValue_FloatArr struct {
	FloatArr *FloatArr `protobuf:"bytes,12,opt,name=floatArr,proto3,oneof"`
}

type PointValue_DoubleArr struct {
	DoubleArr *DoubleArr `protobuf:"bytes,13,opt,name=doubleArr,proto3,oneof"`
}

type PointValue_IntArr struct {
	IntArr *IntArr `protobuf:"bytes,14,opt,name=intArr,proto3,oneof"`
}

type PointValue_DwordArr struct {
	DwordArr *DwordArr `protobuf:"bytes,15,opt,name=dwordArr,proto3,oneof"`
}

type PointValue_LongArr struct {
	LongArr *LongArr `protobuf:"bytes,16,opt,name=longArr,proto3,oneof"`
}

type PointValue_QwordArr struct {
	QwordArr *QwordArr `protobuf:"bytes,17,opt,name=qwordArr,proto3,oneof"`
}
...
var file_hhdb_rpc_base_info_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x22, 0x60, 0x0a, 0x08, 0x47, 0x65, 0x6f, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1c,
	...
	0x74, 0x75, 0x64, 0x65, 0x22, 0xfa, 0x05, 0x0a, 0x0a, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x56, 0x61,
	...
	,
	...
	0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x89, 0x03, 0x0a, 0x09, 0x54,
	...
	,
	...
	,
	...
	0x6b, 0x2f, 0x68, 0x68, 0x64, 0x62, 0x2f, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_hhdb_rpc_base_info_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_hhdb_rpc_base_info_proto_goTypes = []interface{}{
	...
	(PointState)(0),      // 3: hhdb.rpc.PointState
	...
	(*GeoValue)(nil),     // 12: hhdb.rpc.GeoValue
	(*PointValue)(nil),   // 13: hhdb.rpc.PointValue
	(*PointInfo)(nil),    // 14: hhdb.rpc.PointInfo
	(*OperatorInfo)(nil), // 15: hhdb.rpc.OperatorInfo
	(*TableInfo)(nil),    // 16: hhdb.rpc.TableInfo
	nil,                  // 17: hhdb.rpc.PointInfo.ExtraFieldEntry
	nil,                  // 18: hhdb.rpc.TableInfo.ExtraFieldAndDescEntry
}
var file_hhdb_rpc_base_info_proto_depIdxs = []int32{
	12, // 0: hhdb.rpc.PointValue.geoValue:type_name -> hhdb.rpc.GeoValue
	4,  // 1: hhdb.rpc.PointValue.boolArr:type_name -> hhdb.rpc.BoolArr
	5,  // 2: hhdb.rpc.PointValue.floatArr:type_name -> hhdb.rpc.FloatArr
	6,  // 3: hhdb.rpc.PointValue.doubleArr:type_name -> hhdb.rpc.DoubleArr
	7,  // 4: hhdb.rpc.PointValue.intArr:type_name -> hhdb.rpc.IntArr
	8,  // 5: hhdb.rpc.PointValue.dwordArr:type_name -> hhdb.rpc.DwordArr
	9,  // 6: hhdb.rpc.PointValue.longArr:type_name -> hhdb.rpc.LongArr
	10, // 7: hhdb.rpc.PointValue.qwordArr:type_name -> hhdb.rpc.QwordArr
	17, // 8: hhdb.rpc.PointInfo.extraField:type_name -> hhdb.rpc.PointInfo.ExtraFieldEntry
	18, // 9: hhdb.rpc.TableInfo.extraFieldAndDesc:type_name -> hhdb.rpc.TableInfo.ExtraFieldAndDescEntry
	15, // 10: hhdb.rpc.TableInfo.operatorInfo:type_name -> hhdb.rpc.OperatorInfo
...
func file_hhdb_rpc_base_info_proto_init() {
	...
	file_hhdb_rpc_base_info_proto_msgTypes[9].OneofWrappers = []interface{}{
